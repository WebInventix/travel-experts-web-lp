...
const Banner = () => {
  return (
    ...
    >
      ...
      <div className="z-10 text-white mt-20 flex items-center justify-between container mx-auto">
        <div>
          <div className="inline-block bg-white/10 rounded-full px-6 py-2 border border-white/20 mb-3">
            <p className="text-[26px] md:text-lg font-medium font-karla">
              Welcome to Amol Travel
            </p>
          </div>
          <p className="text-lg md:text-3xl font-semibold tracking-wide my-2 font-messiri">
            TRAVEL EXPERTS AND TOUR INC
          </p>
          <h1 className="text-4xl md:text-[70px] font-semibold leading-tight font-messiri">
      ...
      {/* Booking Box */}
      <div className="relative z-10 mt-10 bg-white/60 rounded-2xl p-8 shadow-lg text-black container mx-auto">
        ...
        {/* Input Fields */}
        <div className="grid md:grid-cols-5 gap-4 my-8 font-roboto font-bold text-base">
        ...
        <div className="flex items-center justify-center text-base font-normal font-roboto">
          <button className="bg-[#002B7F] text-white px-[71px] py-[22px] rounded-[50px] hover:opacity-90 hover:cursor-pointer transition flex items-center gap-2">
            <span>
              <FaPlane />
            </span>{" "}
            Search Now
