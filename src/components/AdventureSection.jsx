    ...
    <section className="container mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      <div className="flex flex-col items-center">
        <div className="relative w-full max-w-[560px]">
          ...
          {/* Two overlapping smaller images INSIDE main image */}
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-5">
            {[AdVidImg1, AdVidImg2].map((img, i) => (
              <div
                key={i}
                className="relative w-[230px] h-[130px] bg-white/20 backdrop-blur-md border border-white/30 rounded-xl overflow-hidden shadow-md hover:scale-105 transition-transform duration-500"
              >
                <img
                  src={img}
                  alt=""
